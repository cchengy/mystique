...
export const PT: Record<string, string> = {
  ...
  'Skip': 'Pular',
  'Got it': 'Entendi',
  'She has to work it out.': 'Ela precisa descobrir sozinha.',
  'Mystique arrives with one power: she changes form. No terminal, no files, no web.': 'A Mystique chega com um poder só: mudar de forma. Sem terminal, sem arquivos, sem rede.',
  'Everything else she can do, she earned by talking to another agent.': 'Todo o resto que ela sabe fazer, ela conquistou conversando com outro agente.',
  'She never sees what an agent can do. She only sees it happen, describes what she saw, and a judge decides whether she got it right.': 'Ela nunca vê o que um agente sabe fazer. Ela só vê acontecer, descreve o que viu, e um juiz decide se ela acertou.',
  'Good: she asks': 'Bem: ela pede',
  'Evil: she takes': 'Mal: ela toma',
  'Guided replay': 'Replay guiado',
  'A recorded run, built from the engine’s real messages. Press play and step through it.': 'Uma execução gravada, montada com as mensagens reais do motor. Dê play e avance passo a passo.',
  'It needs no account and no connection at all.': 'Não precisa de conta nem de conexão nenhuma.',
  'Live chat': 'Chat ao vivo',
  'The real engine, working through AG-UI on your own key.': 'O motor de verdade, trabalhando via AG-UI na sua própria chave.',
  'What she learns here is yours, kept apart from everyone else’s.': 'O que ela aprende aqui é seu, separado do de todo mundo.',
  'Your real runs, side by side, with the reasoning she kept from each.': 'Suas execuções reais, lado a lado, com o raciocínio que ela guardou de cada uma.',
  'Connect a model key first — she runs on your OpenRouter account, not ours.': 'Conecte uma chave de modelo primeiro — ela roda na sua conta do OpenRouter, não na nossa.',
  'Then type what you need and she goes looking for whoever has the ability.': 'Depois escreva o que você precisa e ela vai atrás de quem tem a capacidade.',
  'Type what you need. She decides who to approach, and shows you every step.': 'Escreva o que você precisa. Ela decide quem procurar, e mostra cada passo.',
  'Optional: connect Exa in the rail and the Good profile can search the web with sources.': 'Opcional: conecte a Exa na barra lateral e o perfil Bem pode pesquisar na web com fontes.',
